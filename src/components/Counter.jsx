...
const Counter = () => {
  return (
    <div className="w-full  py-5 flex flex-wrap justify-center items-center opacity-70">
      {/* First Counter */}
      <div className="flex-col flex  sm:flex-row flex-wrap justify-center lg:justify-start text-center lg:text-left items-center sm:text-left w-1/2 md:w-[25%] mb-10 sm:mb-4 px-4">
